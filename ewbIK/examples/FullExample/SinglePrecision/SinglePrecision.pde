...
IKPin activePin; 
float zoomScalar = zoomScalar = 200f/height;
...
public void setup() {
    ...
    humanArmature.setDefaultDampening(0.05f);
  ...
  public void draw() {    
    ...
    "\nThe armature you save can be viewed by going to running the"+
     "\n HumanoidLoaderExample > Basic_Loading sketch.";
  ...
  public void initializeBones() {
    ...
    c1 = new Bone(rootBone, "c1", 10f);
    c2 = new Bone(c1, "c2", 10f);
    c3 = new Bone(c2, "c3", 10f);
    c4 = new Bone(c3, "c4", 10f);
    c5 = new Bone(c4, "c5", 10f);
  ...
  public void setBoneConstraints() {    
    ...
    c1j.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
    c1j.optimizeLimitingAxes();

    Kusudama c2j = new Kusudama(c2);
    c2j.addLimitConeAtIndex(0, new PVector(0f,1f,0f), MathUtils.toRadians(10f));
    c2j.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
    ...
    c3j.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
    c3j.optimizeLimitingAxes();

    Kusudama c4j = new Kusudama(c4);
    c4j.addLimitConeAtIndex(0, new PVector(0f,1f,0f), MathUtils.toRadians(10f));
    c4j.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
    ...
    c5j.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
    ...
    neck2j.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
    ...
    headj.setAxialLimits(-MathUtils.toRadians(10f), MathUtils.toRadians(20f));
